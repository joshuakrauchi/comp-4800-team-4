...
const styles = {
  ...
  landingHeader: "self-center mt-10 font-bold",
  landingCrab: "w-[400px] h-[400px] self-center",
  landingRounds: "rounds self-center w-full h-[534px]",
  landingFooter1: "self-center mt-1",
  landingFooter2: "self-center mt-1",
